...
//		System.out.println("=========================> OwnerClasses "+OwnerClasses);
	...
	public boolean AtLeast1T(Requirement requirement,  HashMap<java.lang.String, MethodTrace> methodtraces2HashMap, boolean GoldFlag) throws Exception {
		...
		for (Method method : this) {
			...
			if(!GoldFlag) {
				if (methodtraces2HashMap.get(key).getPredictionOrInputState().equals("T")) 
					return true;
			}else {
	...
	public boolean AtLeast1E(Requirement requirement,  HashMap<java.lang.String, MethodTrace> methodtraces2HashMap, boolean GoldFlag) throws Exception {
		...
		for (Method method : this) {
			...
			if (methodtraces2HashMap.get(key) == null) throw new Exception();
			if(!GoldFlag) {
				if (methodtraces2HashMap.get(key).getPredictionOrInputState().equals("E")) 
					return true;
			}else {
	...
	public boolean AtLeast1N(Requirement requirement,  HashMap<java.lang.String, MethodTrace> methodtraces2HashMap, boolean GoldFlag) throws Exception {
		...
		if(!this.isEmpty()) {
			for (Method method : this) {
				...
				if (methodtraces2HashMap.get(key) == null) throw new Exception();
				if(!GoldFlag) {
					if (methodtraces2HashMap.get(key).getPredictionOrInputState().equals("N")) 
						return true;
				}else {
	...
	public boolean AtLeast1E(Requirement requirement,  HashMap<java.lang.String, MethodTrace> methodtraces2HashMap) throws Exception {
		// TODO Auto-generated method stub
		if(!this.isEmpty()) {
			for (Method method : this) {
				String RequirementID = (String) requirement.ID; 
	...
	public boolean AllNs(Requirement requirement,  HashMap<java.lang.String, MethodTrace> methodtraces2HashMap, boolean GoldFlag) throws Exception {
		...
		if(!this.isEmpty()) {
			for (Method method : this) {
				...
				if(!GoldFlag) {
					if (!methodtraces2HashMap.get(key).getPredictionOrInputState().equals("N")) return false; 
				}else {
	...
	public boolean AllTs(Requirement requirement,  HashMap<java.lang.String, MethodTrace> methodtraces2HashMap, boolean GoldFlag) throws Exception {
		...
		if(!this.isEmpty()) {
			for (Method method : this) {
				...
				if(!GoldFlag) {
					if (!methodtraces2HashMap.get(key).getPredictionOrInputState().equals("T")) return false; 
				}else {
	...
	public boolean AllEs(Requirement requirement,  HashMap<java.lang.String, MethodTrace> methodtraces2HashMap, boolean GoldFlag) throws Exception {
		...
		if(!this.isEmpty()) {
			for (Method method : this) {
				...
				if(!GoldFlag) {
					if (!methodtraces2HashMap.get(key).getPredictionOrInputState().equals("E")) return false; 
				}else {
	...
	public boolean AllTs(Requirement requirement, HashMap<java.lang.String, MethodTrace> methodtraces2HashMap) throws Exception {
		...
		if(!this.isEmpty()) {
			for (Method method : this) {
				...
				if (!trace.getPredictionOrInputState().equals("T")) return false; 
			}
			return true;
		}
